...
def insert_data(apps, schema_editor):
    ...
    Upload.objects.bulk_create([
        Upload(name='NDA'),
        Upload(name='Commercialization Initial Assesment'),
        Upload(name='Community Extension Initial Assesment'),
        Upload(name='Thesis Revision Form'),
        Upload(name='Intellectual Property Application Status'),
        Upload(name='Commercialization Assesment - with TBI'),
        Upload(name='Community Extension'),
        Upload(name='Publication/Conference Presentation/Both'),
        Upload(name='Release Form'),
        Upload(name='Patent'),
        Upload(name='Utility Model'),
        Upload(name='Industrial Design'),
        Upload(name='Trademark'),
        Upload(name='Copyright'),
    ])
